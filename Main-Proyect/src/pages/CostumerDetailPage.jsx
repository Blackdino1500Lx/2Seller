...
export default function CustomerDetailPage() {
  ...
  return (
    <AppShell>
      <Header title={customer.nombre} subtitle="Cliente" showBack />
...
function OrderRow({ order }) {
  ...
  return (
    <div className={`rounded-xl p-3.5 flex items-center justify-between border ${
      pendiente ? 'border-amber-200 bg-amber-50/50' : 'border-slate-200 bg-white'
    }`}>
      <div>
      ...
      <div className="text-right">
        ...
        <p className={`text-[10px] font-semibold ${pendiente ? 'text-amber-700' : 'text-emerald-600'}`}>
